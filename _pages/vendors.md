...
<p>Vendor applications for the 2026 event are now closed. We look forward to seeing you in 2027!</p>
<!-- <p>We are currently accepting <a href = "https://docs.google.com/forms/d/e/1FAIpQLSd61et73fVw9VBFrkdom0Uxj-weqvirNRWcmycqnkpxGC5RrQ/viewform" target ="_blank">applications for vendors, artists, and authors</a> for our 2026 event. Ballroom, artist alley, and writer's block spots are still available, but filling quickly!<p>

<!-- <p>New England FanCon is especially looking for <strong>Trading Card, Video Game, and Figure vendors!</strong></p> -->
...
<ul>
  <li>After Work Hours Decor</li>
  <li>AJ Morrone</li>
  <li>Alex Hoey</li>
  <li>Apothite</li>
  <li>AquaSpiderArt</li>
  <li>Arilyn’s Studio</li>
  <li>Atelier Rougarou</li>
  <li>Bash.Cos</li>
  ...
  <li>Dennis Burke - Caricatures</li>
  <li>Doodlemeowllo</li>
  <li>Elegant Potato Anime</li>
  <li>Emma's Myco Thecary</li>
  <li>Erika's Color Bar</li>
  ...
  <li>Hailium Workshop</li>
  <li>Impact Comic Studios</li>
  <li>Izzyliciousness Designs</li>
  <li>JD Custom Sabers</li>
  <li>Jelly Elixir</li>
  <li>Jimmy Giegerich Illustration</li>
  <li>Jules A.W. Illustration</li>
  <li>Kat2strawberi</li>
  <li>Kenneally Crafts</li>
  <li>Lemon Ray Shop</li>
  <li>Leyenda * Mobile Cafe Bar</li>
  <li>LitePK Illustrations</li>
  <li>Made by Mulchy</li>
  <li>Michael Blank Fantasy Art</li>
  <li>Milky Moonbow</li>
  <li>MOTLI</li>
  <li>My Kawaii Moon KV</li>
  <li>Nia's Earrings Etc</li>
  <li>Nightopia Art</li>
  <li>Noah Alperin</li>
  <li>PhyllidaLuna</li>
  <li>Posuegg</li>
  <li>Pure Raw Brands</li>
  <li>Rae and Tide</li>
  <li>Rain Aung Art</li>
